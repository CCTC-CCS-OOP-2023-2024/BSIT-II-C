...
class Program
{
    ...
    {
        // Basic Concepts 
        Console.WriteLine("Welcome to Gab's Korean Resto!");

        // Variables and Data Types
        int dishesServed = 10;
        double pricePerDish = 499.99;
        string dishType = "Unli Samgyupsal";
        ...
        string welcomeMessage = "Indulge in authentic affordable Korean taste!";
        ...
        {
            case "Happy":
                Console.WriteLine("We're delighted you're enjoying your meal at Gab's Korean Resto!");
                break;
            case "Neutral":
